    ...
    $("#searchBtndb").on("click", function () {
        ...
        .then(function(data){
            ...
            for (i = 0; i < data.length; i++) {
                $("#getrouteresults").append("<strong>Tweet:</strong> " + data[i].text + "<br>");
                $("#getrouteresults").append("<strong>Username:</strong> " + data[i].username + "<br>");
                $("#getrouteresults").append("<strong>Profile:</strong> " + data[i].profile + "<br>");
                $("#getrouteresults").append("<strong>Followers:</strong> " + data[i].followers + "<br>");
                $("#getrouteresults").append("<strong>Location:</strong> " + data[i].location + "<br>");
                $("#getrouteresults").append("<strong>Reweets:</strong> " + data[i].retweets + "<br>");
                $("#getrouteresults").append("<strong>Favorites:</strong> " + data[i].favorites + "<br><br>");
